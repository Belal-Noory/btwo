  ...
  return (
    <div>
        ...
        <div className="text-700 text-justify p-3">
          ...
          <div className="text-700 text-xl text-left pl-4">
          ...
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Integrity and Honesty.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Commitment, transparency, accountability.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Gender Equality.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Team Work.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Respect to human dignity.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Respect to cultural norms of the societies.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> No discrimination.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Professionalism.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Ethical & Gender Sensitive.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Social Justice.</div>
          <div className="text-700 text-xl text-left pl-4"><i className='pi pi-check text-success' /> Respect to all segment of society without discrimination, prejudice to cast, religion, language and race.</div>
        </div>
        <Vision/>
        <WorkArea/>
    </div>
